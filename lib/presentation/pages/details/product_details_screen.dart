    ...
    return AddToCartAnimation(
      ...
      child: Scaffold(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  ...
                  background: Stack(
                    ...
                    children: [
                      ...
                      Hero(
                        tag: controller.args.thumbnail!,
                        child: InkWell(
                          onDoubleTap: () {
                            navigator!.pushNamed(
                              Routes.imageScreen,
                              arguments: ImageScreenArguments(
                                product: controller.args,
                              ),
                            );
                          },
                            ...
                            builder: (BuildContext context, int index) {
                              return PhotoViewGalleryPageOptions(
                                ...
                                imageProvider: MemoryImage(
                                  base64.decode(controller.args.thumbnail!),
                                ),
                                initialScale:
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      'Giá ${formatCurrency(controller.args.price!.toInt())}',
                                      style: TextStyle(
                                        fontSize: 20,
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          'Đánh giá & nhận xét (${controller.comments.value.totalElements})',
                                          style: GoogleFonts.beVietnam(
                                            textStyle: TextStyle(
                                              fontSize: 16,
                                            ),
        ...
        bottomNavigationBar: AddToCard(
          product: controller.args,
          imageLink: controller.args.thumbnail!,
