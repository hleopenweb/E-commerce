                  ...
                  PhotoViewGallery.builder(
                    ...
                    builder: (BuildContext context, int index) {
                      return PhotoViewGalleryPageOptions(
                        imageProvider: NetworkImage('https://onlinehatiya.herokuapp.com${args.product!.thumbnail!}'),
                        maxScale: PhotoViewComputedScale.covered * 2.0,
                        minScale: PhotoViewComputedScale.contained * 0.8,
                        initialScale: PhotoViewComputedScale.contained * 0.8,
                        scaleStateController: controller.controllerState,
                    ...
                    itemCount: args.product!.thumbnail!.length,
                    loadingBuilder: (context, progress) => Center(
                      child: Container(
                        width: 20.0,
                        height: 20.0,
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Image.network(
                              'https://onlinehatiya.herokuapp.com${args.product!.thumbnail}'),
                        ),
                      ),
                    ),
                  );
